                ...
                <div class="col-xs-4 col-xs-offset-6"><br><br><br><br><br>
                    <form class="form-horizontal" method="get">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="mail">E-mail korisnika</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <div style="text-align: center;">
                                <button type="submit" class="btn btn-info" name="nadji">Pronadji korisnika
                                </button>
                            </div>
                        </div>
                    </form>
                    ...
                    <form class="form-horizontal" method="POST" action="" style="margin-top: 100px;" id="dodavanje">
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="ID">ID korisnika</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group" id="tipkorisnika" style="padding-left: 15px!important;">
                            <label class="col-md-4 control-label" for="tipkorisnika">Tip korisnika</label>
                        ...
                        <div class="form-group">
                            <div style="text-align: center;">
                                <button type="submit" class="btn btn-info" name="izmeni">Izmeni korisnika
                                </button>
                            </div>
                        </div>
                    </form>
